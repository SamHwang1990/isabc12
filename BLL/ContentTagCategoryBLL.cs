 ...
 * 类 名 称：ContentTagCategory (ContentTagCategoryBLL)
 * 功能描述：
 * 
******************************************************************/
...
namespace Hope.BLL
{
	...
	/// <summary>
    /// Business Handler ContentTagCategory
    /// </summary>
    public class ContentTagCategoryBLL : BaseBLL
    {
		/// <summary>
        /// 数据访问层接口 IQuery
        /// </summary>
        ...
        private ContentTagCategoryDAL Provider;
		
		private static ContentTagCategoryBLL instance = null;
		
		/// <summary>
        /// Business Handler ContentTagCategoryHandler 
        /// </summary>
        private ContentTagCategoryBLL()
        {
			query = new QueryStringBuilder<ContentTagCategoryData, int>("Content_TagCategory", "TagCategoryID");
            Provider = new ContentTagCategoryDAL(ApplicationConfig.DBConnectionString);
        ...
        /// 获取实例
        /// </summary>
		public static ContentTagCategoryBLL GetInstance()
		{
			if(instance == null)
			{
				instance = new ContentTagCategoryBLL();
			}
        ...
        /// </summary>
        /// <returns>return the handler result</returns>
        public bool Remove(int TagCategoryID)
        {
            HandlerMessage.Code = "00";
            HandlerMessage.Text = "删除成功！";
			HandlerMessage.Succeed = true;
            if (!Provider.Delete(TagCategoryID))
            {
                HandlerMessage.Code = "01";
        ...
        /// <returns>return the handler result</returns>
        public bool Remove(List<int> TagCategoryIDList)
        {
            HandlerMessage.Code = "00";
            HandlerMessage.Text = "删除成功！";
			HandlerMessage.Succeed = true;
            if (!Provider.Delete(TagCategoryIDList))
            {
                HandlerMessage.Code = "01";
                HandlerMessage.Text = "删除失败！";
				HandlerMessage.Succeed = false;
        ...
        {
            return Provider.GetDataById(TagCategoryID);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<ContentTagCategoryData> GetDatas()
        {
        ...
        /// <returns></returns>
        public List<ContentTagCategoryData> GetList(int startIndex, int pageSize)
        {
        ...
        /// <returns></returns>
        public List<ContentTagCategoryData> GetList(int startIndex, int pageSize,string orderColumn, ColumnOrderType orderType)
        {
			int endIndex = startIndex + pageSize - 1; //当前页要显示的记录的结束索引
