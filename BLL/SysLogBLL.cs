...
namespace Hope.BLL
{
    ...
    public class SysLogBLL : BaseBLL
    {
        ...
        private SysLogDAL Provider;
		
		private static SysLogBLL instance = null;
		
		/// <summary>
        /// Business Handler SysLogHandler 
        /// </summary>
        private SysLogBLL()
        {
			query = new QueryStringBuilder<SysLogData, int>("Sys_Log", "LogID");
            Provider = new SysLogDAL(ApplicationConfig.DBConnectionString);
        ...
        /// 获取实例
        /// </summary>
		public static SysLogBLL GetInstance()
		{
			if(instance == null)
			{
				instance = new SysLogBLL();
			}
        ...
        /// </summary>
        /// <returns>return the handler result</returns>
        public bool Remove(int LogID)
        {
            HandlerMessage.Code = "00";
            HandlerMessage.Text = "删除成功！";
			HandlerMessage.Succeed = true;
            if (!Provider.Delete(LogID))
            {
                HandlerMessage.Code = "01";
        ...
        /// <returns>return the handler result</returns>
        public bool Remove(List<int> LogIDList)
        {
            HandlerMessage.Code = "00";
            HandlerMessage.Text = "删除成功！";
			HandlerMessage.Succeed = true;
            if (!Provider.Delete(LogIDList))
            {
                HandlerMessage.Code = "01";
                HandlerMessage.Text = "删除失败！";
				HandlerMessage.Succeed = false;
        ...
        {
            return Provider.GetDataById(LogID);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<SysLogData> GetDatas()
        {
        ...
        /// <returns></returns>
        public List<SysLogData> GetList(int startIndex, int pageSize)
        {
        ...
        /// <returns></returns>
        public List<SysLogData> GetList(int startIndex, int pageSize,string orderColumn, ColumnOrderType orderType)
        {
			int endIndex = startIndex + pageSize - 1; //当前页要显示的记录的结束索引
