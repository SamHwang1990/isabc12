 ...
 * 类 名 称：ContentArticle(ContentArticle)
 * 功能描述：
 * 
******************************************************************/
...
namespace Hope.DAL
{
    ...
    /// ContentArticle
    /// </summary>
    public class ContentArticleDAL : BaseDAL
    {
		#region Constructors
        ...
        public ContentArticleDAL(string conn)
        {
            query = new QueryStringBuilder<ContentArticleData, int>("Content_Article", "GeneralID", conn);
        }
		...
		/// 删除单条记录
		/// </summary>
        /// <param name="GeneralID">需要删除的数据记录ID</param>
        /// <returns>是否删除成功</returns>
        public bool Delete(int GeneralID)
        {
            try
            {
                query.Delete(GeneralID);
                return true;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>是否删除成功</returns>
        public bool Delete(List<int> GeneralIDList)
        {
            try
            {
                query.Delete(GeneralIDList);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public ContentArticleData GetDataById(int GeneralID)
        {
			try
            {
                ...
                return query.GetById(GeneralID);
            }
            catch (Exception ex)
            {
                LogUtil.error(ex.Message);
        ...
        public List<ContentArticleData> GetAll()
        {
         	try
            {
                query.ClearExpression();
        ...
        public List<ContentArticleData> GetPagedList(int startIndex, int endIndex)
        {
        ...
        /// <returns>所有分页记录集</returns>
        public List<ContentArticleData> GetPagedList(int startIndex, int endIndex, string orderColumn, ColumnOrderType orderType)
        {
			try
            {
                query.ClearExpression();
