 ...
 * 类 名 称：ContentStyle(ContentStyle)
 * 功能描述：
 * 
******************************************************************/
...
namespace Hope.DAL
{
    ...
    /// ContentStyle
    /// </summary>
    public class ContentStyleDAL : BaseDAL
    {
		#region Constructors
        ...
        public ContentStyleDAL(string conn)
        {
            query = new QueryStringBuilder<ContentStyleData, int>("Content_Style", "StyleID", conn);
        }
		...
		/// 删除单条记录
		/// </summary>
        /// <param name="StyleID">需要删除的数据记录ID</param>
        /// <returns>是否删除成功</returns>
        public bool Delete(int StyleID)
        {
            try
            {
                query.Delete(StyleID);
                return true;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>是否删除成功</returns>
        public bool Delete(List<int> StyleIDList)
        {
            try
            {
                query.Delete(StyleIDList);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public List<ContentStyleData> GetAll()
        {
         	try
            {
                query.ClearExpression();
        ...
        public List<ContentStyleData> GetPagedList(int startIndex, int endIndex)
        {
        ...
        /// <returns>所有分页记录集</returns>
        public List<ContentStyleData> GetPagedList(int startIndex, int endIndex, string orderColumn, ColumnOrderType orderType)
        {
			try
            {
                query.ClearExpression();
