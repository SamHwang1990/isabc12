...
namespace Hope.DAL
{
    ...
    /// HPUArticle
    /// </summary>
    public class HPUArticleDAL : BaseDAL
    {
		#region Constructors
        ...
        public HPUArticleDAL(string conn)
        {
            query = new QueryStringBuilder<HPUArticleData, int>("HP_U_Article", "ArticleID", conn);
        }
        ...
        public bool Add(HPUArticleData data)
        {
            try
            {
                query.Save(data);
		...
		/// 删除单条记录
		/// </summary>
        /// <param name="ArticleID">需要删除的数据记录ID</param>
        ...
        /// <returns>是否删除成功</returns>
        public bool Delete(List<int> ArticleIDList)
        {
            try
            {
                query.Delete(ArticleIDList);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public HPUArticleData GetDataById(int ArticleID)
        {
			try
            {
                ...
                return query.GetById(ArticleID);
            }
            catch (Exception ex)
            {
                LogUtil.error(ex.Message);
        ...
        public List<HPUArticleData> GetAll()
        {
         	try
            {
                query.ClearExpression();
        ...
        public List<HPUArticleData> GetPagedList(int startIndex, int endIndex)
        {
        ...
        /// <returns>所有分页记录集</returns>
        public List<HPUArticleData> GetPagedList(int startIndex, int endIndex, string orderColumn, ColumnOrderType orderType)
        {
			try
            {
                query.ClearExpression();
