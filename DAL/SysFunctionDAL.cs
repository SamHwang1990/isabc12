...
namespace Hope.DAL
{
    ...
    /// SysFunction
    /// </summary>
    public class SysFunctionDAL : BaseDAL
    {
		#region Constructors
        ...
        public SysFunctionDAL(string conn)
        {
            query = new QueryStringBuilder<SysFunctionData, int>("Sys_Function", "FunctionID", conn);
        }
		...
		/// 删除单条记录
		/// </summary>
        /// <param name="FunctionID">需要删除的数据记录ID</param>
        /// <returns>是否删除成功</returns>
        public bool Delete(int FunctionID)
        {
            try
            {
                query.Delete(FunctionID);
                return true;
            }
            catch (Exception ex)
            {
        ...
        /// <returns>是否删除成功</returns>
        public bool Delete(List<int> FunctionIDList)
        {
            try
            {
                query.Delete(FunctionIDList);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public SysFunctionData GetDataById(int FunctionID)
        {
			try
            {
                ...
                return query.GetById(FunctionID);
            }
            catch (Exception ex)
            {
                LogUtil.error(ex.Message);
        ...
        public List<SysFunctionData> GetAll()
        {
         	try
            {
                query.ClearExpression();
        ...
        public List<SysFunctionData> GetPagedList(int startIndex, int endIndex)
        {
        ...
        /// <returns>所有分页记录集</returns>
        public List<SysFunctionData> GetPagedList(int startIndex, int endIndex, string orderColumn, ColumnOrderType orderType)
        {
			try
            {
                query.ClearExpression();
