...
namespace Hope.DAL
{
    ...
    /// SysModule
    /// </summary>
    public class SysModuleDAL : BaseDAL
    {
		#region Constructors
        ...
        public SysModuleDAL(string conn)
        {
            query = new QueryStringBuilder<SysModuleData, int>("Sys_Module", "ModuleID", conn);
        }
		...
		/// 删除单条记录
		/// </summary>
        /// <param name="ModuleID">需要删除的数据记录ID</param>
        ...
        /// <returns>是否删除成功</returns>
        public bool Delete(List<int> ModuleIDList)
        {
            try
            {
                query.Delete(ModuleIDList);
                return true;
            }
            catch (Exception ex)
            {
        ...
        public List<SysModuleData> GetAll()
        {
         	try
            {
                query.ClearExpression();
        ...
        public List<SysModuleData> GetPagedList(int startIndex, int endIndex)
        {
        ...
        /// <returns>所有分页记录集</returns>
        public List<SysModuleData> GetPagedList(int startIndex, int endIndex, string orderColumn, ColumnOrderType orderType)
        {
			try
            {
                query.ClearExpression();
