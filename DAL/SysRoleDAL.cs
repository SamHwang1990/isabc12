...
namespace Hope.DAL
{
    ...
    public class SysRoleDAL : BaseDAL
    {
        ...
        public SysRoleDAL(string conn)
        {
            query = new QueryStringBuilder<SysRoleData, int>("Sys_Role", "RoleID", conn);
        }
		...
		/// 删除单条记录
		/// </summary>
        /// <param name="RoleID">需要删除的数据记录ID</param>
        ...
        public List<SysRoleData> GetAll()
        {
         	try
            {
                query.ClearExpression();
        ...
        public List<SysRoleData> GetPagedList(int startIndex, int endIndex)
        {
        ...
        /// <returns>所有分页记录集</returns>
        public List<SysRoleData> GetPagedList(int startIndex, int endIndex, string orderColumn, ColumnOrderType orderType)
        {
			try
            {
                query.ClearExpression();
