...
(function () {
    ...
    e.prototype = {set:function (q, m) {
        ...
        return g[(this.dom.tagName || "").toLowerCase()] || Ext.isBorderBox
    }, remove:function () {
        var l = this, m = l.dom;
        if (m) {
            delete l.dom;
...
Ext.Element.addMethods(function () {
    ...
    function w(E) {
        return h[E] || (h[E] = E == "float" ? v : E.replace(y, p))
    }

    return{adjustWidth:function (E) {
        var F = this;
        var G = (typeof E == "number");
        ...
        var J = this, H, E, G, F = [];
        if (!Ext.isArray(I)) {
            if (typeof I == "string" && !this.hasClass(I)) {
                J.dom.className += " " + I
            }
        } else {
            for (H = 0, E = I.length; H < E; H++) {
                G = I[H];
                if (typeof G == "string" && (" " + J.dom.className + " ").indexOf(" " + G + " ") == -1) {
                    F.push(G)
                }
            }
            if (F.length) {
        ...
        var K = this, I, F, E, H, G;
        if (!Ext.isArray(J)) {
            J = [J]
        }
        if (K.dom && K.dom.className) {
            G = K.dom.className.replace(l, "").split(u);
        ...
        var I = this.dom.parentNode.childNodes, F, G, E;
        H = Ext.isArray(H) ? H : [H];
        ...
        var H = this.getStyle(E), G = (typeof J != "undefined") ? J : "#", I;
        ...
        for (F in H) {
            G = H[F];
            F == "opacity" ? this.setOpacity(G) : this.dom.style[w(F)] = G
        }
        return this
        ...
        return E
    }, addStyles:function (L, K) {
        var I = 0, J = L.match(b), H, G, F, E = J.length;
        for (F = 0; F < E; F++) {
            H = J[F];
            G = H && parseInt(this.getStyle(K[H]), 10);
            if (G) {
                I += r.abs(G)
            }
        }
...
Ext.slider.MultiSlider = Ext.extend(Ext.BoxComponent, {vertical:false, minValue:0, maxValue:100, decimalPrecision:0, keyIncrement:1, increment:0, clickRange:[5, 15], clickToChange:true, animate:true, dragging:false, constrainThumbs:true, topThumbZIndex:10000, initComponent:function () {
...
Ext.form.CompositeField = Ext.extend(Ext.form.Field, {defaultMargins:"0 5 0 0", skipLastItemMargin:true, isComposite:true, combineErrors:true, labelConnector:", ", initComponent:function () {
    ...
    return a.join(this.labelConnector)
}, isDirty:function () {
    if (this.disabled || !this.rendered) {
        return false
    }
