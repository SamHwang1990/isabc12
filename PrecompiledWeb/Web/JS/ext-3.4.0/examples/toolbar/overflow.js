            ...
            items:[
                {
                    ...
                    menu:[
                        {text:'Menu Item 1', handler:handleAction.createCallback('Menu Item 1')}
                    ]
                },
                '-',
                {
                    ...
                    menu:[
                        {text:'Cut menu', handler:handleAction.createCallback('Cut menu')}
                    ]
                },
                {
                    text:'Copy',
                ...
                },
                {
                    ...
                    iconCls:'add16',
                    menu:[
                        {text:'Paste menu', handler:handleAction.createCallback('Paste menu')}
                    ]
                },
                '-',
                {
