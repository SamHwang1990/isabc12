    ...
    if (Ext.isObject(b)) {
        ...
        for (var g in h) {
            ...
            if (Ext.isFunction(h[g])) {
                this.mons.push({item:f, ename:g, fn:h[g], scope:h.scope});
...
(function () {
    ...
    Ext.extend(Ext.Layer, Ext.Element, {getZIndex:function () {
        ...
        if (!this.updating && this.isVisible() && (m || this.useShim)) {
            var g = this.getShim(), k = this.getWidth(), i = this.getHeight(), e = this.getLeft(true), n = this.getTop(true);
...
Ext.Container = Ext.extend(Ext.BoxComponent, {bufferResize:50, autoDestroy:true, forceLayout:false, defaultType:"panel", resizeEvent:"resize", bubbleEvents:["add", "remove"], initComponent:function () {
    ...
    var d = arguments, g = d.length, a = [], f, h;
    this.initItems();
    if (g > 2) {
        for (f = g - 1; f >= 1; --f) {
    ...
    var j = this.rendered, h = e || this.forceLayout;
...
Ext.layout.ContainerLayout = Ext.extend(Object, {monitorResize:false, activeItem:null, constructor:function (a) {
    ...
    Ext.apply(this, a)
}, type:"container", IEMeasureHack:function (j, f) {
    var a = j.dom.childNodes, b = a.length, m, l = [], k, g, h;
    for (g = 0; g < b; g++) {
        m = a[g];
        k = Ext.get(m);
        if (k) {
    ...
    var b = e.items.items, d, g, a = b.length;
    for (d = 0; d < a; d++) {
        g = b[d];
    ...
    var e = f.getLayoutTarget(), g = f.items.items, a = g.length, d, h, b = [];
    for (d = 0; d < a; d++) {
...
Ext.layout.AutoLayout = Ext.extend(Ext.layout.ContainerLayout, {type:"auto", monitorResize:true, onLayout:function (d, f) {
...
Ext.layout.AnchorLayout = Ext.extend(Ext.layout.ContainerLayout, {monitorResize:true, type:"anchor", defaultAnchor:"100%", parseAnchorRE:/^(r|right|b|bottom)$/i, getLayoutTargetSize:function () {
    ...
    for (r = 0; r < s; r++) {
        ...
        if (k.anchor) {
            ...
            if (c || e) {
                f.push({component:k, width:c || undefined, height:e || undefined})
            }
        }
    }
...
Ext.layout.ColumnLayout = Ext.extend(Ext.layout.ContainerLayout, {monitorResize:true, type:"column", extraCls:"x-column", scrollOffset:0, targetCls:"x-column-layout-ct", isValidParent:function (b, a) {
    ...
    var f = e.items.items, g = f.length, l, b, a, n = [];
    this.renderAll(e, j);
    var q = this.getLayoutTargetSize();
...
Ext.layout.AccordionLayout = Ext.extend(Ext.layout.FitLayout, {fill:true, autoWidth:true, titleCollapse:true, hideCollapseTool:false, collapseFirst:false, animate:false, sequence:false, activeOnTop:false, type:"accordion", renderItem:function (a) {
    ...
    if (this.fill && f) {
        var d = 0, c, b = this.getRenderedItems(this.container), a = b.length, g;
        for (c = 0; c < a; c++) {
            if ((g = b[c]) != f && !g.hidden) {
...
Ext.layout.BoxLayout = Ext.extend(Ext.layout.ContainerLayout, {defaultMargins:{left:0, top:0, right:0, bottom:0}, padding:"0", pack:"start", monitorResize:true, type:"box", scrollOffset:0, extraCls:"x-box-item", targetCls:"x-box-layout-ct", innerCls:"x-box-inner", constructor:function (a) {
    ...
    if (d.width > 0) {
        var j = this.overflowHandler, a = i.tooNarrow ? "handleOverflow" : "clearOverflow";
        var e = j[a](c, d);
        if (e) {
            if (e.targetSize) {
                d = e.targetSize
    ...
    var h = this.align, f = this.padding, e = c.width, a = c.height;
    if (this.type == "hbox") {
        var b = e, d = g.meta.maxHeight + f.top + f.bottom;
        if (h == "stretch") {
            d = a
        } else {
            if (h == "middle") {
        ...
        var d = a, b = g.meta.maxWidth + f.left + f.right;
        if (h == "stretch") {
            b = e
        } else {
            if (h == "center") {
    ...
    var f = f || this.container, e = f.getLayoutTarget(), g = f.items.items, a = g.length, d, h, b = [];
    for (d = 0; d < a; d++) {
...
Ext.layout.boxOverflow.Menu = Ext.extend(Ext.layout.boxOverflow.None, {afterCls:"x-strip-right", noItemsMenuText:'<div class="x-toolbar-no-items">(None)</div>', constructor:function (a) {
    ...
    var e = f.width + (this.afterCt ? this.afterCt.getWidth() : 0), b = this.menuItems;
    this.hideTrigger();
    ...
    var b = this.menuItems, a = b.length, f, e;
    var c = function (i, h) {
...
Ext.layout.boxOverflow.HorizontalMenu = Ext.extend(Ext.layout.boxOverflow.Menu, {constructor:function () {
    ...
    b.calculateChildBoxes = function (d, h) {
        var k = a.apply(b, arguments), j = k.meta, e = c.menuItems;
        var i = 0;
    ...
    for (var n = 0, c = this.menuItems.length; n < c; n++) {
        var m = this.menuItems[n], l = m.component, b = m.width;
        if (b < a) {
            l.show();
            a -= b;
            f++;
    ...
    if (q) {
        ...
        for (var h = k.length - 1; h >= 0; h--) {
            var p = k[h].component, o = k[h].left + k[h].width;
            if (o >= j) {
                this.menuItems.unshift({component:p, width:k[h].width});
                p.hide()
            } else {
                break
            }
...
Ext.layout.boxOverflow.Scroller = Ext.extend(Ext.layout.boxOverflow.None, {animateScroll:true, scrollIncrement:100, wheelIncrement:3, scrollRepeatInterval:400, scrollDuration:0.4, beforeCls:"x-strip-left", afterCls:"x-strip-right", scrollerCls:"x-strip-scroller", beforeScrollerCls:"x-strip-scroller-left", afterScrollerCls:"x-strip-scroller-right", createWheelListener:function () {
    ...
    var d = this.getItem(e).getBox(true, true), a = d.x, c = d.x + d.width, f = this.getScrollPosition(), b = this.layout.innerCt.getWidth() + f;
...
Ext.layout.HBoxLayout = Ext.extend(Ext.layout.BoxLayout, {align:"top", type:"hbox", calculateChildBoxes:function (q, b) {
    var E = q.length, Q = this.padding, C = Q.top, T = Q.left, x = C + Q.bottom, N = T + Q.right, a = b.width - this.scrollOffset, e = b.height, n = Math.max(0, e - x), O = this.pack == "start", V = this.pack == "center", z = this.pack == "end", K = 0, P = 0, S = 0, k = 0, W = 0, G = [], j, I, L, U, v, h, R, H, c, w, p, M;
    for (R = 0; R < E; R++) {
        j = q[R];
        L = j.height;
        I = j.width;
    ...
    if (o) {
        ...
        if (J > 0) {
            ...
            for (var D = 0, u = E; D < u; D++) {
                var A = q[D], s = A.minWidth || 0;
                if (A.flex) {
                    G[D].width = s
                } else {
                    B.push({minWidth:s, available:G[D].width - s, index:D})
                }
            }
            B.sort(function (X, i) {
...
Ext.layout.VBoxLayout = Ext.extend(Ext.layout.BoxLayout, {align:"left", type:"vbox", calculateChildBoxes:function (n, b) {
    var D = n.length, Q = this.padding, B = Q.top, U = Q.left, w = B + Q.bottom, N = U + Q.right, a = b.width - this.scrollOffset, c = b.height, J = Math.max(0, a - N), O = this.pack == "start", W = this.pack == "center", y = this.pack == "end", j = 0, t = 0, T = 0, K = 0, l = 0, F = [], g, H, M, V, s, f, S, G, R, v, m, d, q;
    for (S = 0; S < D; S++) {
        g = n[S];
        M = g.height;
        H = g.width;
    ...
    if (k) {
        for (S = 0, q = D; S < q; S++) {
            F[S].height = n[S].minHeight || n[S].height || F[S].height
        }
    } else {
        if (L > 0) {
            var I = [];
            for (var C = 0, q = D; C < q; C++) {
                var z = n[C], r = z.minHeight || 0;
                if (z.flex) {
                    F[C].height = r
                } else {
                    I.push({minHeight:r, available:F[C].height - r, index:C})
                }
            }
            I.sort(function (X, i) {
                return X.available > i.available ? 1 : -1
            ...
            for (S = 0; S < D; S++) {
                ...
                s = g.margins;
                v = s.left + s.right;
                if (O && g.flex && !g.height) {
                    R = Math.ceil((g.flex / o) * P);
                    P -= R;
                    o -= g.flex;
                    G.height = R;
                    G.dirtySize = true
...
Ext.layout.ToolbarLayout = Ext.extend(Ext.layout.ContainerLayout, {monitorResize:true, type:"toolbar", triggerWidth:18, noItemsMenuText:'<div class="x-toolbar-no-items">(None)</div>', lastOverflow:false, tableHTML:['<table cellspacing="0" class="x-toolbar-ct">', "<tbody>", "<tr>", '<td class="x-toolbar-left" align="{0}">', '<table cellspacing="0">', "<tbody>", '<tr class="x-toolbar-left-row"></tr>', "</tbody>", "</table>", "</td>", '<td class="x-toolbar-right" align="right">', '<table cellspacing="0" class="x-toolbar-right-ct">', "<tbody>", "<tr>", "<td>", '<table cellspacing="0">', "<tbody>", '<tr class="x-toolbar-right-row"></tr>', "</tbody>", "</table>", "</td>", "<td>", '<table cellspacing="0">', "<tbody>", '<tr class="x-toolbar-extras-row"></tr>', "</tbody>", "</table>", "</td>", "</tr>", "</tbody>", "</table>", "</td>", "</tr>", "</tbody>", "</table>"].join(""), onLayout:function (e, h) {
    ...
    this.lastWidth = b;
    if (h > b || (e && m)) {
        var k = this.container.items.items, g = k.length, d = 0, n;
        for (var f = 0; f < g; f++) {
            n = k[f];
            if (!n.isFill) {
    ...
    var b = this.container.items.items, a = b.length, f, e;
    var c = function (i, h) {
        return i.isXType("buttongroup") && !(h instanceof Ext.Toolbar.Separator)
    };
    this.clearMenu();
...
Ext.DatePicker = Ext.extend(Ext.BoxComponent, {todayText:"Today", okText:"&#160;OK&#160;", cancelText:"Cancel", todayTip:"{0} (Spacebar)", minText:"This date is before the minimum date", maxText:"This date is after the maximum date", format:"m/d/y", disabledDaysText:"Disabled", disabledDatesText:"Disabled", monthNames:Date.monthNames, dayNames:Date.dayNames, nextText:"Next Month (Control+Right)", prevText:"Previous Month (Control+Left)", monthYearText:"Choose a month (Control+Up/Down to move years)", startDay:0, showToday:true, focusOnSelect:true, initHour:12, initComponent:function () {
    ...
    var a = ['<table cellspacing="0">', '<tr><td class="x-date-left"><a href="#" title="', this.prevText, '">&#160;</a></td><td class="x-date-middle" align="center"></td><td class="x-date-right"><a href="#" title="', this.nextText, '">&#160;</a></td></tr>', '<tr><td colspan="3"><table class="x-date-inner" cellspacing="0"><thead><tr>'], c = this.dayNames, g;
    for (g = 0; g < 7; g++) {
    ...
    if (this.rendered) {
        ...
        if (this.showToday) {
            var l = new Date().clearTime(), c = (l < s || l > x || (E && y && E.test(l.dateFormat(y))) || (H && H.indexOf(l.getDay()) != -1));
            if (!this.disabled) {
...
Ext.slider.Thumb = Ext.extend(Object, {dragging:false, constructor:function (a) {
    ...
    if (this.constrain) {
        var a = c.thumbs[b + 1], g = c.thumbs[b - 1];
...
Ext.slider.MultiSlider = Ext.extend(Ext.BoxComponent, {vertical:false, minValue:0, maxValue:100, decimalPrecision:0, keyIncrement:1, increment:0, clickRange:[5, 15], clickToChange:true, animate:true, constrainThumbs:true, topThumbZIndex:10000, initComponent:function () {
    ...
    var l = b == "top" ? this.innerEl.getHeight() - j[b] : j[b], f = this.reverseValue(l), h = (this.maxValue - this.minValue) + 5, e = 0, c = null;
    for (var d = 0; d < this.thumbs.length; d++) {
        var a = this.thumbs[d], k = a.value, g = Math.abs(k - f);
        if (Math.abs(g <= h)) {
            c = a;
            e = d;
            h = g
