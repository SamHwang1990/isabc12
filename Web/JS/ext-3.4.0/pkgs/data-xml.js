...
Ext.extend(Ext.data.XmlReader, Ext.data.DataReader, {read:function (a) {
    ...
    this.xmlData = d;
    var a = d.documentElement || d, c = Ext.DomQuery, f = 0, e = true;
    ...
    var e = Ext.DomQuery, g = b.responseXML, a = g.documentElement || g;
    var c = new Ext.data.Response({action:f, success:this.getSuccess(a), message:this.getMessage(a), data:this.extractData(e.select(this.meta.record, a) || e.select(this.meta.root, a), false), raw:g});
