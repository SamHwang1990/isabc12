...
(function () {
    ...
    suite.add(new Y.Test.Case({
        ...
        testMarkInvalidWithArray:function () {
            ...
            this.form.markInvalid([
                {id:'email', msg:'is the wrong format'}
            ]);
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp:function () {
            ...
            this.item1 = buildFormItem({name:'name', getValue:function () {
                return 'ed';
            }});
            this.item2 = buildFormItem({name:'email'});
            this.item3 = buildFormItem({name:'phone', getValue:function () {
                return '333';
            }});
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp:function () {
            ...
            this.item2 = buildFormItem({name:'email', getValue:function () {
                return 'ed@extjs.com';
            }});
            this.item3 = buildFormItem({name:'phone', getValue:function () {
                return '333';
