...
(function () {
    ...
    suite.add(new Y.Test.Case({
        ...
        testHeightDominatesFlex:function () {
            var items = [
                buildFakeChild({flex:1, height:250, getHeight:function () {
                    return 250;
                }}),
                buildFakeChild({flex:1}),
                buildFakeChild({flex:1}),
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp:function () {
            this.items = [
                buildFakeChild({flex:1, getWidth:function () {
                    return 10;
                }}),
                buildFakeChild({flex:1, getWidth:function () {
                    return 20;
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp:function () {
            this.items = [
                buildFakeChild({getSize:function () {
    ...
    suite.add(new Y.Test.Case({
        ...
        setUp:function () {
            ...
            this.items = [
                buildFakeChild({getWidth:function () {
                    return 50;
                }, flex:1}),
                buildFakeChild({getWidth:function () {
                    return 60;
